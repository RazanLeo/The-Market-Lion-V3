  ...
  return (
    <main className="min-h-screen grid place-items-center px-4 bg-black">
      <div className="w-full max-w-md gold-card p-8 shadow-gold">
        ...
        <p className="text-center text-zinc-400 text-sm mb-1">The Market Lion</p>
        <p className="text-center text-zinc-500 text-xs mb-6">Owner & Admin team only</p>
        ...
        <form action="/api/admin/login" method="post" className="space-y-4">
          <div>
            <label className="text-sm text-gold-400 mb-1 block">Email</label>
          ...
          <div>
            <label className="text-sm text-gold-400 mb-1 block">Password</label>
        ...
        <p className="text-xs text-zinc-600 text-center mt-6">Any unauthorized access is logged and blocked.</p>
      </div>
    </main>
  );
}
